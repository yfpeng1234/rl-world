...
"""
from verl.trainer.ppo.ray_trainer import RayVGPTPPOTrainer
...
@hydra.main(config_path='config', config_name='vgpt_ppo_trainer', version_base=None)
def main(config):
    run_ppo(config)
...
class TaskRunner:
    ...
    def run(self, config):
        ...
        trainer = RayVGPTPPOTrainer(config=config,
