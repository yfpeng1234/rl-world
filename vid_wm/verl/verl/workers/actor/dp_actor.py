            ...
            for batch_idx, data in enumerate(dataloader):
                ...
                for data in micro_batches:
                    ...
                    if self.config.interact:
                        response_mask = copy.deepcopy(attention_mask[:, -response_length:])  # [B, T * (H*W+d)]
                        # TODO: magic number
                        response_mask = response_mask.reshape(response_mask.shape[0], -1, 93)
                        response_mask[:, :, 80:] = 0.0
                        response_mask = response_mask.reshape(*attention_mask[:, -response_length:].shape)
                    else:
